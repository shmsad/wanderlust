      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm">
            ...
            <p className="mt-4 text-sm text-gray-900 dark:text-gray-100">
              ...
              offering unique stays across the country. Whether you're looking
              for a cozy room, an entire home, or a peaceful retreat, Prabhat
              helps you find the perfect place to stay.
            </p>
          </div>
        </div>
        <div className="space-y-2 text-sm">
          <p className="text-base font-bold tracking-wide text-gray-900 dark:text-gray-50">
            Contacts
          </p>
          <div className="flex">
          ...
          <div className="flex">
            <p className="mr-1 text-gray-900 dark:text-gray-100">Address:</p>
            <a
        ...
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            <a href="/" className="text-gray-500 hover:text-deep-purple-accent-400">
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        ...
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            <a
              href="/"
              className="text-sm text-gray-500 hover:text-deep-purple-accent-400"
            >
              F.A.Q
            </a>
          </li>
